            ...
            <TableBody>
              {gmailTemplates &&
                ...
                gmailTemplates.map((template) => (
                  <GmailTemplateRow key={template.id} {...template} role={role} handleGmailTemplateEdit={handleGmailTemplateEdit} />
                ))}
            </TableBody>
          </Table>
        </TableContainer>
            ...
            <TableBody>
              {kixieTemplates &&
                ...
                kixieTemplates.map((template) => (
                  <KixieTemplateRow key={template.id} {...template} role={role} handleKixieTemplateEdit={handleKixieTemplateEdit} />
                ))}
            </TableBody>
          </Table>
        </TableContainer>
