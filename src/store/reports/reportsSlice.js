  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getSMSReport.fulfilled, (state, { payload }) => {
        ...
        localStorage.setItem('smsData', JSON.stringify(payload.weekData ? payload.weekData : []));
        localStorage.setItem('totalSMSSent', JSON.stringify(payload.totalSMSSentAllTime ? payload.totalSMSSentAllTime : 0));
      })
